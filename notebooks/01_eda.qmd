...
Although the dataset contains several high-value cases in miles, receipts, and reimbursement, these points should not be removed. They represent legitimate long-distance or high-cost trips rather than data errors. Since ACME's legacy system computes reimbursements for all travel events, including extreme or unusual ones, these outliers are essential or accurately replicating the system's true behavior. 
...
- The consistency of reimbursement calculations even at extreme values suggests that the legacy system does not apply caps, filters, or strong input validation on the raw data. 
